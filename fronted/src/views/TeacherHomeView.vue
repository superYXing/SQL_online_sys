      ...
      <el-main class="main-content">
        <div class="content-wrapper">
          ...
          <div class="right-section">
            <!-- 个人信息卡片 -->
            <div class="teacher-card" v-loading="teacherLoading">
              <h3>📋 个人信息</h3>
              <div class="info-grid">
                <div class="info-item">
                  <label>教师编号:</label>
                  <span>{{ teacherInfo.teacher_id || '-' }}</span>
                </div>
                <div class="info-item">
                  <label>姓名:</label>
                ...
                <div class="info-item">
                  <label>当前学期:</label>
                  <span>{{ teacherInfo.semester_name || '-' }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="quick-actions-card">
              ...
              <div class="actions-grid">
                ...
                <el-button type="success" @click="goToDatabaseSchema" class="action-btn">
                  <el-icon><Grid /></el-icon>
                  数据库模式
                </el-button>
                <el-button type="warning" @click="goToProblem" class="action-btn">
                  <el-icon><Document /></el-icon>
                  题目管理
                </el-button>
                <el-button type="info" @click="goToStudentInfo" class="action-btn">
...
import { ArrowDown, DataAnalysis, Document, User, Grid } from '@element-plus/icons-vue'
...
const fetchTeacherInfo = async () => {
  ...
  try {
    ...
    if (response.data) {
      ...
      console.log('教师信息加载成功:', response.data)
    }
  } catch (error: unknown) {
